...
- ✅ **Next** — post-game draft review, Season 17→18 trend views, generated TypeScript types
- ⏳ **Open** — flex-rate UI, per-role breakdowns in the UI, standings-based validation invariant
