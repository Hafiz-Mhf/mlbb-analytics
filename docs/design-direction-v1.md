...
- **Team color coding**: each of the 8 MPL MY teams gets a small identifying swatch/tag next to its name in tables — needed once the dashboard is team-agnostic, wasn't a concern for a single-team analysis. The Season 18 eight are AC Esports, Bigetron MY by VIT, Invictus Gaming, RRQ Tora, Selangor Red Giants, Team Flash, Team Rey, Team Vamos (data-source.md). Swatches attach to the stable team identity, not the display name — sponsor suffixes change between seasons and the colour should not.
