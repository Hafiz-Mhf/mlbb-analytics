...
- **Team color coding**: each of the 8 MPL MY teams gets a small identifying swatch/tag next to its name in tables — needed once the dashboard is team-agnostic, wasn't a concern for a single-team analysis
