...
- [ ] Head-to-Head Matchup Tool — Select two teams (e.g., SRG vs Team Flash) to compare draft tendencies, contested hero priority, side pick preferences, and head-to-head history.
